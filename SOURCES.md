...
These patterns install agents from [crafting-demo/agent-hub](https://github.com/crafting-demo/agent-hub) (see [HUB.md](HUB.md)). Attribution lives in that repo's `SOURCES.md` and each agent's README.
